...
<div class="linkedin-profile">
  ...
  <?php if ($profile['skills']['value']) : ?>
    <b> Skills: </b>
    <ul>
    <?php foreach ($profile['skills']['value']['skill'] as $skill) : ?>
      <li class="linkedin-skill"><?php print $skill['skill']['name']; ?>
    <?php endforeach; ?>
    </ul>
  <?php endif; ?>
        <ul>
    <?php foreach ($profile as $key => $value) : ?>
    <?php if ($value && !in_array($key, array ('picture-url', 'first-name', 'last-name', 'skills'))) : ?>
